...
public:
	 ...
	 * RETURNED VALUE    : void
	 */
	static void centrage(int& xc, int& yc, int iW, int iH, Uint8 cnt = nocenter);
...
public:
	 ...
	 */
	virtual bool searchButtonImage(Uint8 stateScreen, signed int x, signed int y);
...
public:
	 ...
	 * RETURNED VALUE    : void
	 */
	virtual void resetOnPlayer(unsigned int selectplayer, std::vector<std::string> tabPlayerName);

...
{
	logfileconsole("Create Player Par Defaut Success");
}

Player::Player(const std::string &msg) : _name(msg)
{
	logfileconsole("Create Player Success");
}
...
Player::~Player() {
	...
	for (unsigned int i = 0; i < size; i++) {
		...
		logfileconsole("Kill Unit n:" + to_string(i) + " of Player: " + _name + " Success");
	}
	...
	if (_tabunit.size() != 0)
		logfileconsole("___________ERROR : _tabunit.size() != 0");
	else
		logfileconsole("Kill ALL Unit of Player:" + _name + " Success");
	...
	for (unsigned int i = 0; i < size; i++) {
		...
		logfileconsole("Kill Citie n:" + to_string(i) + " of Player: " + _name + " Success");
	}
	...
	if (_tabcities.size() != 0)
		logfileconsole("___________ERROR : _tabcities.size() != 0");
	else
		logfileconsole("Kill ALL Cities of Player:" + _name + " Success");
...
vector<Units*> Player::GETtabunit() const{
	return _tabunit;
}
...
vector<Cities*> Player::GETtabcities() const{
	return _tabcities;
}
